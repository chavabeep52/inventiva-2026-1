...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Votaciones INVENTIVA EAFIT" },
      { name: "description", content: "Sistema interno de votación por mesa para INVENTIVA EAFIT 2026-1." },
      { name: "author", content: "Universidad EAFIT" },
      { property: "og:title", content: "Votaciones INVENTIVA EAFIT 2026-1" },
      { property: "og:description", content: "Sistema interno de votación por mesa." },
